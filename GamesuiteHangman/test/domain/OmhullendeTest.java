...
public class OmhullendeTest {
	...
	@Test
	public void getMinimumX_geeft_juiste_minimum_x() {
		assertTrue(linkerBovenhoek.getX() == omhullende.getMinimumX());
	}

	@Test
	public void getMinimumY_geeft_juiste_minimum_y() {
		assertTrue(linkerBovenhoek.getY() == omhullende.getMinimumY());
	}

	@Test
	public void getMaximumX_geeft_juiste_maximum_x() {
		assertTrue(linkerBovenhoek.getX() + breedte == omhullende.getMaximumX());
	}

	@Test
	public void getMaximumY_geeft_juiste_maximum_y() {
		assertTrue(linkerBovenhoek.getY() + hoogte == omhullende.getMaximumY());
	}
}
