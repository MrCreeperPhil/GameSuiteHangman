	...
	public class RaadLuisteraar implements KeyListener {
		...
		public void keyPressed(KeyEvent arg0) {
			if (arg0.getKeyCode() == KeyEvent.VK_ENTER) {
				...
				if (spel.isGameOver()) {
					JOptionPane.showMessageDialog(null, "Spijtig, je hebt het spel verloren!");
					if (JOptionPane.showConfirmDialog(null, "Wil je opnieuw spelen?", "Game Over",
					...
					JOptionPane.showMessageDialog(null, "Proficiat, je hebt gewonnen!");
					if (JOptionPane.showConfirmDialog(null, "Wil je opnieuw spelen?", "Gewonnen",
							JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
						reset();
					} else {
						System.exit(0);
				...
				// TODO
				// toon boodschap als gewonnen of verloren en vraag of speler
				// opnieuw wilt spelen
				// als de speler opnieuw wilt spelen: herzet het spel en het
				// paneel
