...
public class Driehoek {
	...
	public void setHoekPunten(Punt hoekPunt1, Punt hoekPunt2, Punt hoekPunt3){
		...
		if((hoekPunt1.getY()-hoekPunt2.getY())/(hoekPunt1.getX()-hoekPunt2.getX())==
				(hoekPunt2.getY()-hoekPunt3.getY())/(hoekPunt2.getX()-hoekPunt3.getX())){
	...
	public boolean equals(Object object){
		if(object instanceof Driehoek){
			...
			if(this.getHoekPunt1().equals(driehoek.getHoekPunt1()) &&  this.getHoekPunt2().equals(driehoek.getHoekPunt2())  &&  this.getHoekPunt3().equals(driehoek.getHoekPunt3())){
			return true;
			}
		}
		return false;
